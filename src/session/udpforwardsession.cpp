...
UDPForwardSession::UDPForwardSession(const Config &config, SStatus &sstatus, boost::asio::io_context &io_context, context &ssl_context, const udp::endpoint &endpoint, UDPWrite in_write) :
