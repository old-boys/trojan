...
public:
    UDPForwardSession(const Config &config, SStatus &sstatus, boost::asio::io_context &io_context, boost::asio::ssl::context &ssl_context, const boost::asio::ip::udp::endpoint &endpoint, UDPWrite in_write);
