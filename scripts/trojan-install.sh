...
NAME=trojan
VERSION=$(curl -fsSL https://api.github.com/repos/old-boys/trojan/releases/latest | grep tag_name | sed -E 's/.*"v(.*)".*/\1/')
TARBALL="$NAME-linux-amd64.tar.xz"
DOWNLOADURL="https://github.com/old-boys/$NAME/releases/download/v$VERSION/$TARBALL"
TMPDIR="$(mktemp -d)"
